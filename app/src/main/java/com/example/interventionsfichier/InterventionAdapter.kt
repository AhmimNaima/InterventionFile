package com.example.interventionsfichier
...
class InterventionAdapter(private val mCtx: Context, private val list: Array<Intervention>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):InterventionViewHolder {
        val view = LayoutInflater.from(mCtx).inflate(com.example.interventionsfichier.R.layout.item_view, parent, false)
    ...
    inner class InterventionViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        init {
            ...
            item_numero= itemView.findViewById(com.example.interventionsfichier.R.id.item_numero)
            item_nom = itemView.findViewById(com.example.interventionsfichier.R.id.item_nom)
            item_type = itemView.findViewById(com.example.interventionsfichier.R.id.item_type)
            item_date = itemView.findViewById(com.example.interventionsfichier.R.id.item_date)
